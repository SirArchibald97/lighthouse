...
export const badges = {
    ...
    battle_box_tiered: [
        ...
        { name: "Ace in the Box", description: "Personally eliminate all 4 members of the opposing team in%%rounds of Battle Box", icon: "battle_box/ace_in_the_box", stat: "ace", game: "battle_box", tiers: [
