...
<div class="w-full grid grid-cols-3 gap-x-4 pb-4">
    <!-- TROPHIES -->
    <div class="flex gap-x-4 border border-neutral-800 rounded-md p-2">
        <span 
            class={`flex justify-center items-center size-18 bg-neutral-100 rounded-full ${getCrownColour(player.crownLevel.fishingLevelData.level)}`}  
        ...
        >
            <span class="flex justify-center items-center size-14 bg-neutral-900 rounded-full">
                <img src="https://cdn.islandstats.xyz/icons/trophies/blue.png" alt="Angler Trophy Icon" class="size-8" />
            </span>
        </span>
        <div class="self-center">
            <p class="text-lg font-semibold">Angler Trophies</p>
    ...
    <div class="flex gap-x-4 border border-neutral-800 rounded-md p-2">
        ...
        <div class="self-center">
            <p class="text-lg font-semibold">Fish Caught</p>
            <div class="flex gap-x-2 tabular-nums">
                <p>
    ...
    <div class="flex gap-x-4 border border-neutral-800 rounded-md p-2">
        ...
        >
            <span class="flex justify-center items-center size-14 bg-neutral-900 rounded-full">
                <img src="https://cdn.islandstats.xyz/fishing/stars/gargantuan.png" alt="Gargantuan Red Star Icon" class="size-8" />
            </span>
        </span>
        <div class="self-center">
            <p class="text-lg font-semibold">Weights Caught</p>
            <div class="flex gap-x-2 tabular-nums">
                <p>
