...
export interface IslandAuctionListing {
	__typename: string;
	asset: {
...
export interface IslandAuctionListingsResponse {
	data: {
		activeIslandExchangeListings: IslandAuctionListing[];
		soldIslandExchangeListings: IslandAuctionListing[];
	};
}
