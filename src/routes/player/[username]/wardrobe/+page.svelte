                                            ...
                                            <div class="flex flex-col gap-y-1">
                                                ...
                                                <div class="flex gap-x-1">
                                                    ...
                                                    {#if cosmetic.type !== "STANDARD"}
                                                        <img src="https://cdn.islandstats.xyz/icons/rarity/{cosmetic.type.toLowerCase()}.png" alt="{cosmetic.type} Icon" class="h-3 md:h-4 self-center" />
                                                    {/if}
                                                </div>
                                                            ...
                                                            <div class="flex gap-x-2 text-sm lg:text-base">
                                                                ...
                                                                <div class="flex flex-col gap-y-1">
                                                                    <div class="flex gap-x-2">
                                                                        ...
                                                                        <span class="size-5 self-center text-neutral-300 cursor-pointer"><Info /></span>
                                                                        <Tooltip arrow={false} type="custom" placement="top" class="text-sm border !border-neutral-700 !bg-neutral-900 px-2 py-0.5 rounded-md">
                                                                            {cosmetic.obtainmentHint}
                                                                        </Tooltip>
                                                                    </div>
